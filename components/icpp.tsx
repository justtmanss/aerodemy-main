...
const stats = [
    { label: "Rs. 10,000", value: "ADAPT Test" },
    { label: "Rs. 10,000", value: "Group Discussion" },
    { label: "Rs. 10,000", value: "Personal Interview" },
    { label: "Rs. 27,000", value: "Full Course" },
];
const values = [
    {
                ...
                <div className="px-6 pt-14 lg:px-8">
                    <div className="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
                        <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                            <span className="text-[#223a94]">Indigo</span> Cadet{" "}
                            <span className="text-[#bf9b30]">Pilot</span>{" "}
                            Program
                        </h2>
                        <p className="mt-6 text-lg leading-8 text-gray-300">
                            Our Indigo Cadet Pilot Program preperatory course is
                            a comprehensive and intensive course meticulously
                            designed to empower aspiring aviators, providing
                    ...
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                        <div className="grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-300 lg:max-w-none lg:grid-cols-2">
                            <p>
                                ...
                                <br /> - Maths Test: Assessing quantitative
                                reasoning skills.
                                <br /> - Physics Test:Evaluating understanding
                                and application of physics principles.
                                <br /> - Cognitive Reasoning Practice
                                Test:Focusing on problem-solving abilities.
                                <br />
                                - FAST Practice Test: Quick assessments to gauge
                                responsiveness.
                                <br /> - Control and Coordination: Assessing
                                motor skills and spatial awareness.
                                <br /> - ADAPT Personality Questionnaire: A
                                holistic evaluation of personality traits.
                                <br /> - English Test: Assessing English
                                Listening, Comprehensive and Vocabulary skills.
                                <br /> - Flight simulator: Assessing skills such
                                as listening, hand-eye coordination and
                        ...
                        <div className="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
                            <div className="course-container p-8 rounded-lg shadow-lg">
                                ...
                                <div className="module">
                                    <h2 className="text-xl font-semibold mb-4 text-[#bf9b30]">
                                        2. ADAPT Test Preparation
                                    </h2>
                                    <p className="mb-4">
                                        Prepare for the ADAPT Test with a 5-hour
                                        session, including tips and mock tests
